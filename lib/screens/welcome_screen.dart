...
import 'package:proje_one/widgets/navbar_roots.dart';
import 'package:proje_one/screens/signup_screen.dart';

class WeelcomeScreen extends StatelessWidget{
  @override
    ...
    return Material(
      child: Container(
        ...
        child: Column(
         ...
         child: Image.asset("images/login-sign1.png"),
         ),
         SizedBox(height: 50),
